# Line length
The length of the line should not exceeds 80 characters long.

# Naming convention
You may only use the letter a-z, the captial A-Z, and the number 0-9, and the underscore character '_'.

You may not start a variable name with a number.
